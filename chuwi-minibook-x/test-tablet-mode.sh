...
MODULE_PATH="/home/greymouser/Projects/noonshy/repos/minibook-x-tools/chuwi-minibook-x/chuwi-minibook-x.ko"
SYSFS_MODE="/sys/devices/platform/chuwi-minibook-x/mode"
...
sudo rmmod chuwi-minibook-x 2>/dev/null || true
sleep 1
